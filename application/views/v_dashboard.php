                    ...
                    <div class="row">
                        <div class="col-md-3 mb-4 stretch-card transparent">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="mb-4 font-weight-bold text-success text-uppercase">Total Data Barang</div>
                                    <div class="fs-30 mb-2" style="font-size: 40px;"><?= $total_barang; ?>
                        ...
                        <div class="col-md-3 mb-4 stretch-card transparent">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="mb-4 font-weight-bold text-primary text-uppercase">Total Stok Barang</div>
                        ...
                        <div class="col-md-3 mb-4 stretch-card transparent">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="mb-4 font-weight-bold text-danger text-uppercase">Total Barang dipinjam</div>
                                    <div class="fs-30 mb-2" style="font-size: 40px;"><?= $barang_pinjam; ?>
